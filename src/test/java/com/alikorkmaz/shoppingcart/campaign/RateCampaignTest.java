...
class RateCampaignTest {
    ...
    public void setUp() {
        ...
        rateCampaign = new RateCampaign(10, 5, food);
    }
    ...
    public void should_return_true_when_campaign_minimum_item_quantity_less_than_total_item_quantity_by_category() {
        ...
        //when
        boolean val = rateCampaign.isApplicableFor(cart);
    ...
    public void should_return_discount_amount() {
        //given
        double cartAmount = 100.0;

        //when
        double discountAmount = rateCampaign.getDiscountAmount(cartAmount);

        //then
        assertThat(discountAmount).isEqualTo(10.0);
    }
}